...
# 데이터 로드
pickle_path = '/Users/ljh/Downloads/와인_리뷰데이터.pkl'
base_total = pd.read_pickle(pickle_path)

# 와인 타입별 이미지 파일 경로
wine_images = {
    "레드 와인": "/Users/ljh/Desktop/스크린샷 2024-12-26 오후 12.38.38.png",
    "화이트 와인": "/Users/ljh/Desktop/스크린샷 2024-12-26 오후 12.38.03.png",
    "로제 와인": "images/rose_wine.jpg",
    "샴페인": "images/champagne.jpg"
}
    ...
    if st.button("추천 받기"):
        ...
        if recommendations:
            ...
            for wine in recommendations:
                image_path = wine_images.get(wine['Type'], "images/default_wine.jpg")
